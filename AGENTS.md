...
- Each window has: type (e.g. fiveHour, weekly), used ratio (0-1), reset time, optional provider-reported duration, display label, an optional provider-stable `Id`, and an optional language-neutral `GroupLabel` (model/family scope).
